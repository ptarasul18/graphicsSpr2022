...
//	g_modelMatrix.setIdentity();
	...
	// you can comment out this 'setIdentity()' call with no on-screen change...
		...
		//----------------------------------------------------------
	console.log("stack size before 1st push:", __cuon_matrix_mod_stack.length);
	pushMatrix(g_modelMatrix);
	console.log("stack size after 1st push:", __cuon_matrix_mod_stack.length);
	//-----------------------------------------------------------
...
//-------Draw Lower Arm---------------
  ...
  // DRAW PINCERS:====================================================
	...
	//----------------------------------------------------------
	//----------------------------------------------------------
	console.log("stack size before 2nd push:", __cuon_matrix_mod_stack.length);
	pushMatrix(g_modelMatrix);
	console.log("stack size after 2nd push:", __cuon_matrix_mod_stack.length);
	//-----------------------------------------------------------
	//-----------------------------------------------------------
...
// g_modelMatrix.printMe("before pop");
	//---------------------
	console.log("stack size before 1st pop:", __cuon_matrix_mod_stack.length);
	g_modelMatrix = popMatrix();
	console.log("stack size after 1st pop:", __cuon_matrix_mod_stack.length);
	//----------------------
// g_modelMatrix.printMe("AFTER");
  ...
  gl.uniformMatrix4fv(uLoc_modelMatrix, false, g_modelMatrix.elements);
  gl.drawArrays(gl.TRIANGLES, 0, g_vertCount);	// draw all vertices.
// g_modelMatrix.printMe("before pop2");
	//---------------------
	console.log("stack size before 2nd pop:", __cuon_matrix_mod_stack.length);
	g_modelMatrix = popMatrix();
	console.log("stack size after 2nd pop:", __cuon_matrix_mod_stack.length);
	//----------------------
// g_modelMatrix.printMe("AFTER");
}
